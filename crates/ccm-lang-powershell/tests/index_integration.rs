//! Runs the real `ccm-index` pipeline against a small multi-file PowerShell
...
// untrusted repo content (see crates/ccm-lang-powershell/src/ for that policy).
...
use ccm_lang_powershell::PowerShellParser;
